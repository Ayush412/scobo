  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.5,
        centerTitle: true,
        title: Text("STATS", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 22, color: Colors.black)),
      ),
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text(loginBloc.userMap['Name'], style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 18))
              ),
              Padding(
